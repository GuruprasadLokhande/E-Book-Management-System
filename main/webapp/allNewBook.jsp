...
<head>
<meta charset="UTF-8">
<title>E-BOOK: ALL NEW BOOK</title>
...
<body style="background-color: #e1e7ed">
	...
	<c:if test="${not empty addcart}">
		<p class="popup text-center" id="popupMsg">${addcart}</p>
		<%
	...
	<script>
		...
		showPopupMessage(3000); // 3000 milliseconds = 3 seconds
	</script>
	...
	<div class="container">
		...
		<div class="row">
			...
			List<bookDetails> list2 = dao2.allNewBook();
