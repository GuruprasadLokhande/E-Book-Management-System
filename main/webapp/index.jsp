...
<head>
<meta charset="UTF-8">
<title>PROJECT E-BOOK MANAGEMENT</title>
...
<body style="background-color: #e1e7ed">
	...
	<div class="container-fluid back-img">
		<h2 class="text-center text-white p-5 " id="element"></h2>
	</div>
	...
	<!-- Start Recent Book -->
	<div class="container">
		<h3 class="text-center text-black mt-3">Recent Books</h3>
		<div class="row">
	...
	<!-- Start New Book -->
	<div class="container">
		<h3 class="text-center text-black mt-3">New Books</h3>
		<div class="row">

			<%
			BookDAOImpl dao2 = new BookDAOImpl(DBMSConnect.getConn());
	...
	<!-- Start Old Book -->
	<div class="container">
		<h3 class="text-center text-black mt-3">Old Books</h3>
		<div class="row">
			<%
			BookDAOImpl dao3 = new BookDAOImpl(DBMSConnect.getConn());
	...
	<script>
		var typed = new Typed('#element', {
			strings : [ "E-BOOK MANAGEMENT SYSTEM" ],
			typeSpeed : 100,
		});
	</script>
	<script>
